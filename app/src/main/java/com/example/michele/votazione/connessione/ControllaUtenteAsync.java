...
public class ControllaUtenteAsync extends AsyncTask<String, Void, String> {
    ...
    public ControllaUtenteAsync(Context context,String idConcorso, String imei){
    ...
    protected void onPostExecute(String result) {
        ...
        if (result != null) {
            ...
            if(bool){
                ...
                Intent i = new Intent(context, VotazioneUtente.class);
