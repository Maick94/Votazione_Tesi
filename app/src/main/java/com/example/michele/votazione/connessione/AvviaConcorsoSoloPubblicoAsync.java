...
public class AvviaConcorsoSoloPubblicoAsync extends AsyncTask<String, Void, String> {

    private ProgressDialog loadingDialog;
    private Context context;
    private static String progetto;

    public AvviaConcorsoSoloPubblicoAsync(Context context){
    ...
    protected String doInBackground(String... params) {
        ...
        if(isNetworkAvailable(context)){
            ...
            try{
                ...
                // Link
                String link ="http://databaseandroid.altervista.org/app/Control/AvviaConcorsoSoloPubblicoControl.php" + data;
                Log.d("DEBUG-------:", link);
