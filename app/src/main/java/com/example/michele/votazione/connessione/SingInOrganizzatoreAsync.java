...
/**
 * Created by Michele on 25/03/2020.
 */

public class SingInOrganizzatoreAsync extends AsyncTask<String, Void, String> {
    ...
    public SingInOrganizzatoreAsync(Context context){
    ...
    protected String doInBackground(String... params) {
        ...
        if(isNetworkAvailable(context)){
            ...
            try{
                ...
                // Link
                String link ="http://databaseandroid.altervista.org/app/Control/SingInOrganizzatoreControl.php" + data;
                Log.d("DEBUG-------:", link);
    ...
    protected void onPostExecute(String result) {
        ...
        if (result != null) {
            ...
            if(bool){
                Toast.makeText(context, "Organizzatore registrato correttamente", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(context, RegistrazioneOrganizzatore.class);
                //intent.putExtra("Numero", (Serializable) 0);
                context.startActivity(intent);
            } else {
                Toast.makeText(context, "Errore: Username già presente  organizzatore non registrato", Toast.LENGTH_SHORT).show();
            }
