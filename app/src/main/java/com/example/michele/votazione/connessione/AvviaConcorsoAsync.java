...
public class AvviaConcorsoAsync extends AsyncTask<String, Void, String> {

    private ProgressDialog loadingDialog;
    private Context context;
    private static String progetto;

    public AvviaConcorsoAsync(Context context){
    ...
    protected String doInBackground(String... params) {
        ...
        if(isNetworkAvailable(context)){
            ...
            try{
                ...
                // Link
                String link ="http://databaseandroid.altervista.org/app/Control/AvviaConcorsoControl.php" + data;
                Log.d("DEBUG-------:", link);
