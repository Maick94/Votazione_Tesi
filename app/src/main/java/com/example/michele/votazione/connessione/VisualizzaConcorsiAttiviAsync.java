...
public class VisualizzaConcorsiAttiviAsync extends AsyncTask<String, Void, String> {

    //private ProgressDialog loadingDialog;
    private Context context;

    public VisualizzaConcorsiAttiviAsync(Context context){
    ...
    protected String doInBackground(String... params) {
        ...
        if(isNetworkAvailable(context)){
            ...
            try{
                ...
                // Link
                String link = "http://databaseandroid.altervista.org/app/Control/VisualizzaConcorsiAttiviControl.php";
                Log.d("DEBUG:", link);
