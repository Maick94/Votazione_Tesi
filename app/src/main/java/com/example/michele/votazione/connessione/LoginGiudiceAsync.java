...
public class LoginGiudiceAsync extends AsyncTask<String, Void, String> {

    private ProgressDialog loadingDialog;
    private Context context;
    private static String giudice;
    private String idConcorso;
    private String imei;

    public LoginGiudiceAsync(Context context,String idConcorso,String imei){
    ...
    protected String doInBackground(String... params) {
        ...
        if(isNetworkAvailable(context)){
            ...
            try{
                ...
                String data = "?giudice=" + URLEncoder.encode(giudice, "UTF-8");

                // Link
                String link = "http://databaseandroid.altervista.org/app/Control/LoginGiudiceControl.php" + data;
                Log.d("DEBUG-------:", link);
    ...
    protected void onPostExecute(String result) {
        ...
        if (result != null) {
            ...
            if(bool){
                ...
                Intent i = new Intent(context, VotazioneGiuria.class);
