...
/**
 * Created by Michele on 27/03/2020.
 */

public class VisualizzaConcorsiApertiOrganizzatoreAsync extends AsyncTask<String, Void, String> {
    ...
    public VisualizzaConcorsiApertiOrganizzatoreAsync(Context context){
    ...
    protected String doInBackground(String... params) {
        ...
        if(isNetworkAvailable(context)){
            ...
            try{
                ...
                // Link
                String link = "http://databaseandroid.altervista.org/app/Control/VisualizzaConcorsiApertiOrganizzatoreControl.php" + data;
                Log.d("DEBUG-------:", link);
