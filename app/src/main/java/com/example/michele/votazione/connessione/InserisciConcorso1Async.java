...
/**
 * Created by Michele on 26/03/2020.
 */

public class InserisciConcorso1Async extends AsyncTask<String, Void, String> {
    ...
    public InserisciConcorso1Async(Context context){
    ...
    protected String doInBackground(String... params) {
        ...
        if(isNetworkAvailable(context)){
            ...
            try{
                ...
                // Link
                String link ="http://databaseandroid.altervista.org/app/Control/InserisciConcorso1Control.php" + data;
                Log.d("DEBUG-------:", link);
    ...
    protected void onPostExecute(String result) {
        ...
        if (result != null) {
            ...
            if(bool){
                Toast.makeText(context, "Concorso registrato correttamente", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(context, HomeOrganizzatore.class);
                intent.putExtra("Numero", (Serializable) 1);
                context.startActivity(intent);
            } else {
                Toast.makeText(context, "Errore: Concorso non registrato riprovare", Toast.LENGTH_SHORT).show();
            }
