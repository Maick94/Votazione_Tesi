...
import com.example.michele.votazione.LoginGiuria;
...
/**
 * Created by Michele on 17/04/2020.
 */

public class ControllaUtente2Async extends AsyncTask<String, Void, String> {
    ...
    public ControllaUtente2Async(Context context,String idConcorso, String imei){
    ...
    protected String doInBackground(String... params) {
        ...
        if(isNetworkAvailable(context)){
            ...
            try{
                ...
                String data = "?utente=" + URLEncoder.encode(utente, "UTF-8");

                // Link
                String link = "http://databaseandroid.altervista.org/app/Control/ControllaUtenteControl.php" + data;
                Log.d("DEBUG-------:", link);
    ...
    protected void onPostExecute(String result) {
        ...
        if (result != null) {
            ...
            if(bool){
                Toast.makeText(context, "Accesso negato: il tuo dispositivo già ha completato la votazione", Toast.LENGTH_SHORT).show();
            } else {
                Intent i = new Intent(context, LoginGiuria.class);
                i.putExtra("IdConcorso", (Serializable) idConcorso);
                i.putExtra("imei", (Serializable) imei);
