...
public class NonAvviaConcorsoAsync extends AsyncTask<String, Void, String> {

    private ProgressDialog loadingDialog;
    private Context context;
    private static String progetto;

    public NonAvviaConcorsoAsync(Context context){
    ...
    protected String doInBackground(String... params) {
        ...
        if(isNetworkAvailable(context)){
            ...
            try{
                ...
                // Link
                String link ="http://databaseandroid.altervista.org/app/Control/NonAvviaConcorsoControl.php" + data;
                Log.d("DEBUG-------:", link);
    ...
    protected void onPostExecute(String result) {
        ...
        if (result != null) {
            ...
            if(bool){
                Toast.makeText(context, "Dati registrati correttamente", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(context, HomeOrganizzatore.class);
                intent.putExtra("Numero", (Serializable) 1);
                context.startActivity(intent);
            } else {
                Toast.makeText(context, "Errore: Dati non registrati riprovare", Toast.LENGTH_SHORT).show();
            }
