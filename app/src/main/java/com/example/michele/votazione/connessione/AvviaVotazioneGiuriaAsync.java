...
/**
 * Created by Michele on 03/04/2020.
 */

public class AvviaVotazioneGiuriaAsync extends AsyncTask<String, Void, String> {

    private ProgressDialog loadingDialog;
    private Context context;
    private static String progetto;

    public AvviaVotazioneGiuriaAsync(Context context){
    ...
    protected String doInBackground(String... params) {
        ...
        if(isNetworkAvailable(context)){
            ...
            try{
                ...
                // Link
                String link = "http://databaseandroid.altervista.org/app/Control/AvviaVotazioneGiuriaControl.php"+data;
                Log.d("DEBUG:", link);
