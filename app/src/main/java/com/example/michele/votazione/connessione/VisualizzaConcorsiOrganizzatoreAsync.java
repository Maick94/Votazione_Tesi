...
public class VisualizzaConcorsiOrganizzatoreAsync extends AsyncTask<String, Void, String> {
    ...
    public VisualizzaConcorsiOrganizzatoreAsync(Context context){
    ...
    protected String doInBackground(String... params) {
        ...
        if(isNetworkAvailable(context)){
            ...
            try{
                ...
                // Link
                String link = "http://databaseandroid.altervista.org/app/Control/VisualizzaConcorsiOrganizzatoreControl.php" + data;
                Log.d("DEBUG-------:", link);
