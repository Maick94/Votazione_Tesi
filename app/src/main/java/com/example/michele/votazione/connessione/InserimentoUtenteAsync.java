...
public class InserimentoUtenteAsync extends AsyncTask<String, Void, String> {


    private Context context;
    private static String utente;

    public InserimentoUtenteAsync(Context context){
    ...
    protected String doInBackground(String... params) {
        ...
        if(isNetworkAvailable(context)){
            ...
            try{
                ...
                // Link
                String link ="http://databaseandroid.altervista.org/app/Control/InserimentoUtenteControl.php" + data;
                Log.d("DEBUG-------:", link);
